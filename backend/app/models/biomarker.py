...
class DeviceConnection(BaseModel):
    device_id: str
    device_name: str
    device_type: str  # smartwatch, fitness_tracker, or manual
...
class BiomarkerSummary(BaseModel):
    # for daily/weekly/monthly summaries
    user_id: str
...
class ManualDataEntry(BaseModel):
    biomarker_type: str  # blood_pressure, mood, weight, etc
    value: Any  # can be number or dict (for BP)
